...
fn main() -> Result<(), Box<dyn std::error::Error>> {
	...
	// Header
	typescript_code.push_str("// Generated by Spacedrive using Specta + rspc-inspired type extraction - DO NOT EDIT\n");
	typescript_code.push_str("// This file is auto-generated. See core/src/bin/generate_typescript_types.rs\n\n");
	...
	println!("\nSummary:");
	println!("   • Core Actions: {} operations", api_structure.core_actions.len());
	println!("   • Library Actions: {} operations", api_structure.library_actions.len());
	println!("   • Core Queries: {} queries", api_structure.core_queries.len());
	println!("   • Library Queries: {} queries", api_structure.library_queries.len());
	println!("\nNext steps:");
