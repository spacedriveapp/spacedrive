...
//!
//! Changes route to either `PersistentWriter` (database writes for
//! managed locations) or `EphemeralWriter` (in-memory updates for browsing
...
pub use persistent::{PersistentWriter, PersistentWriterAdapter};
