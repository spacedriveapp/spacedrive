...
impl LibraryAction for LocationRescanAction {
    ...
    async fn execute(self, library: std::sync::Arc<crate::library::Library>, _context: Arc<CoreContext>) -> Result<Self::Output, ActionError> {
        ...
        let location = entities::location::Entity::find()
            ...
            .ok_or_else(|| ActionError::Internal(format!("Location not found: {}", self.location_id)))?;
