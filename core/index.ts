...
export type Operations = {
    queries: 
        ...
        { key: ["p2p.discoveredPeers"], result: Array<PeerCandidate> } | 
        ...
        { key: ["p2p.getNodes", LibraryArgs<null>], result: Array<Node> } | 
        ...
        { key: ["p2p.connectedPeers"], result: Record<PeerId, PeerMetadata> } | 
        { key: ["jobs.getRunning", LibraryArgs<null>], result: Array<JobReport> },
    mutations: 
        { key: ["p2p.unpairNode", LibraryArgs<PeerId>], result: null } | 
        { key: ["files.delete", LibraryArgs<number>], result: null } | 
        { key: ["library.create", string], result: null } | 
        { key: ["p2p.pairNode", LibraryArgs<PeerId>], result: string } | 
        ...
        { key: ["p2p.acceptPairingRequest", AcceptPairingRequestArgs], result: null } | 
...
export interface AcceptPairingRequestArgs { peer_id: PeerId, preshared_key: string }
...
export interface NodeState { version: string | null, id: string, name: string, p2p_port: number | null, p2p_cert: Array<number>, p2p_key: Array<number>, spacetunnel_addr: string | null, data_path: string }
...
export interface NodeConfig { version: string | null, id: string, name: string, p2p_port: number | null, p2p_cert: Array<number>, p2p_key: Array<number>, spacetunnel_addr: string | null }
...
export interface PeerCandidate { id: PeerId, metadata: PeerMetadata, addresses: Array<string>, port: number }
...
export type OperationSystem = "Windows" | "Linux" | "MacOS" | "IOS" | "Android" | { Other: string }
...
export interface PeerMetadata { name: string, operating_system: OperationSystem | null, version: string | null }
