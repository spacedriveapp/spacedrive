...
export type Operations = {
	queries:
		...
		| {
				key: ['locations.getExplorerDir', LibraryArgs<GetExplorerDirArgs>];
	...
	mutations:
		...
		| {
				key: ['jobs.generateThumbsForLocation', LibraryArgs<GenerateThumbsForLocationArgs>];
				result: null;
		  }
...
export interface Node {
	...
	date_created: string;
	sync_events: Array<SyncEvent> | null;
	jobs: Array<Job> | null;
...
export interface Tag {
	...
	date_created: string;
	date_modified: string;
	tag_files: Array<TagOnFile> | null;
}
...
export interface Location {
	...
	date_created: string;
	node: Node | null | null;
	file_paths: Array<FilePath> | null;
}

export interface LabelOnFile {
	date_created: string;
	label_id: number;
	label: Label | null;
	file_id: number;
...
export interface Label {
	...
	date_created: string;
	date_modified: string;
	label_files: Array<LabelOnFile> | null;
}
...
export interface GetExplorerDirArgs {
	location_id: number;
	path: string;
	limit: number;
}
...
export interface File {
	...
	date_modified: string;
	date_indexed: string;
	tags: Array<TagOnFile> | null;
	labels: Array<LabelOnFile> | null;
	albums: Array<FileInAlbum> | null;
	spaces: Array<FileInSpace> | null;
	paths: Array<FilePath> | null;
	comments: Array<Comment> | null;
	media_data: MediaData | null | null;
	key: Key | null | null;
}
