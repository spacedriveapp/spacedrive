...
async fn assign_existing_objects_to_file_paths(
	...
	db: &PrismaClient,
	sync: &Arc<SyncManager>,
) -> Result<Vec<file_path::id::Type>, sd_core_shared_errors::job::file_identifier::Error> {
...
async fn assign_objects_to_duplicated_orphans(
	...
	sync: &Arc<SyncManager>,
	device_id: device::id::Type,
) -> Result<(Vec<file_path::id::Type>, u64), sd_core_shared_errors::job::file_identifier::Error> {
