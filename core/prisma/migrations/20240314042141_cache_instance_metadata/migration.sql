/*
  ...
  - You are about to drop the column `node_id` on the `instance` table. All the data in the column will be lost.
  ...
  - Added the required column `metadata` to the `instance` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_instance" ("date_created", "id", "identity", "last_seen", "pub_id", "timestamp") SELECT "date_created", "id", "identity", "last_seen", "pub_id", "timestamp" FROM "instance";
DROP TABLE "instance";
