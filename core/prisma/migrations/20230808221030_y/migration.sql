/*
  ...
  - You are about to alter the column `artist` on the `media_data` table. The data in that column could be lost. The data in that column will be cast from `String` to `Binary`.
  - You are about to alter the column `copyright` on the `media_data` table. The data in that column could be lost. The data in that column will be cast from `String` to `Binary`.
...
INSERT INTO "new_media_data" ("artist", "camera_data", "codecs", "copyright", "dimensions", "duration", "fps", "id", "location", "media_date", "streams") SELECT "artist", "camera_data", "codecs", "copyright", "dimensions", "duration", "fps", "id", "location", "media_date", "streams" FROM "media_data";
