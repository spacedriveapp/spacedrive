...
\begin{table*}[ht]
    ...
    \begin{tabular}{llrr}
	\toprule
    \textbf{Phase} & \textbf{Hardware} & \textbf{Value} & \textbf{Unit} \\
	\midrule
	\multicolumn{3}{l}{\textit{Indexing}} \\
	\csvreader[
	late after line=\\
    ]{../benchmarks/results/whitepaper_metrics.csv}{Phase=\Phase,Hardware=\Hardware,Value=\Value,Unit=\Unit}{%
    \Phase & \Hardware & \num{\Value} & \Unit
	}
	\midrule
