...
```rust
// core-new/src/domain/indexer_rule.rs
...
```rust
// core-new/src/services/indexer_rules/engine.rs
...
```rust
// Modify core-new/src/operations/indexing/indexer_job.rs
impl IndexerJob {
...
```rust
// Extend core-new/src/location/manager.rs
...
```rust
// Extend core-new/src/services/location_watcher/event_handler.rs
impl EventHandler {
