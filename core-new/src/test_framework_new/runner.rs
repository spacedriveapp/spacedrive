...
impl CargoTestRunner {
    ...
    pub fn add_subprocess(mut self, name: impl Into<String>, test_function_name: impl Into<String>) -> Self {
        let name = name.into();
    ...
    pub async fn spawn_single_process(&mut self, name: &str) -> Result<(), String> {
        ...
        println!("🚀 Spawned cargo test process: {} (test: {})", process.name, process.test_function_name);
