...
// 				#[allow(unsafe_code)]
// 				unsafe {
// 					Self::new(std::mem::transmute_copy(&value))
// 				}
// 			}
// 			false => Self::default(),
// 		}
...
// impl From<u32> for FlashValue {
// 	fn from(value: u32) -> Self {
// 		FlashValue::from(value)
// 	}
// }

// impl Into<FlashValue> for u32 {
// 	fn into(self) -> FlashValue {
// 		let mut value = FlashValue::default();

// #[allow(unsafe_code)]
// unsafe {
// 	// value = std::mem::transmute(FlashValue::new(self))
...
// ugly but better than trying to `atd::mem::transmutate`
// impl From<u32> for FlashValue {
// 	fn from(value: u32) -> Self {
// 		match value {
// 			0x00 => Self::NoFire,
