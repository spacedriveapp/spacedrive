...
impl From<Equals> for WhereParam {
	fn from(Equals(v): Equals) -> Self {
		WhereParam::Delay(_prisma::read_filters::IntFilter::Equals(v))
	}
}
::prisma_client_rust::scalar_where_param_fns!(_prisma::read_filters::IntFilter, Delay, {
...
impl From<Set> for SetParam {
	fn from(Set(v): Set) -> Self {
		Self::Delay(_prisma::write_params::IntParam::Set(v))
	}
}
