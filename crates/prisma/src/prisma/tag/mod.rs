...
::prisma_client_rust::macros::select_factory!(
	...
	[
		...
		(tag_objects, Relation(prisma::tag_on_object, Many))
	]
);
...
impl Into<::prisma_client_rust::Selection> for SelectParam {
	fn into(self) -> ::prisma_client_rust::Selection {
		match self {
			...
			Self::TagObjects(data) => data.into(),
		}
	}
}
...
::prisma_client_rust::macros::partial_unchecked_factory!(
	_partial_unchecked_tag,
	prisma::tag,
	struct Data {
		#[serde(rename = "id")]
		pub id: prisma::tag::id::Type,
		#[serde(rename = "pub_id")]
		pub pub_id: prisma::tag::pub_id::Type,
		#[serde(rename = "name")]
		#[serde(default, with = "::prisma_client_rust::serde::double_option")]
		pub name: prisma::tag::name::Type,
		#[serde(rename = "color")]
		#[serde(default, with = "::prisma_client_rust::serde::double_option")]
		pub color: prisma::tag::color::Type,
		#[serde(rename = "is_hidden")]
		#[serde(default, with = "::prisma_client_rust::serde::double_option")]
		pub is_hidden: prisma::tag::is_hidden::Type,
		#[serde(rename = "date_created")]
		#[serde(default, with = "::prisma_client_rust::serde::double_option")]
		pub date_created: prisma::tag::date_created::Type,
		#[serde(rename = "date_modified")]
		#[serde(default, with = "::prisma_client_rust::serde::double_option")]
		pub date_modified: prisma::tag::date_modified::Type,
	}
);
