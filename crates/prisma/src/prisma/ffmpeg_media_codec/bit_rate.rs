...
impl From<Equals> for WhereParam {
	fn from(Equals(v): Equals) -> Self {
		WhereParam::BitRate(_prisma::read_filters::IntFilter::Equals(v))
	}
}
::prisma_client_rust::scalar_where_param_fns!(_prisma::read_filters::IntFilter, BitRate, {
...
impl From<Set> for SetParam {
	fn from(Set(v): Set) -> Self {
		Self::BitRate(_prisma::write_params::IntParam::Set(v))
	}
}
