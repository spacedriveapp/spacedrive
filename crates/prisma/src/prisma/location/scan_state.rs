...
impl From<Equals> for WhereParam {
	fn from(Equals(v): Equals) -> Self {
		WhereParam::ScanState(_prisma::read_filters::IntFilter::Equals(v))
	}
}
::prisma_client_rust::scalar_where_param_fns!(_prisma::read_filters::IntFilter, ScanState, {
...
impl From<Set> for SetParam {
	fn from(Set(v): Set) -> Self {
		Self::ScanState(_prisma::write_params::IntParam::Set(v))
	}
}
...
impl Into<super::SelectParam> for Select {
	fn into(self) -> super::SelectParam {
		super::SelectParam::ScanState(self)
	}
}
...
impl Into<super::IncludeParam> for Include {
	fn into(self) -> super::IncludeParam {
		super::IncludeParam::ScanState(self)
	}
}
