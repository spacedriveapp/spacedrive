...
pub enum WhereParam {
	...
	IsHidden(super::_prisma::read_filters::BooleanNullableFilter),
...
pub enum SetParam {
	...
	IsHidden(super::_prisma::write_params::BooleanNullableParam),
...
::prisma_client_rust::macros::select_factory!(
	...
	[
		...
		(objects, Relation(prisma::object_in_album, Many))
	]
);
...
impl Create {
	pub fn to_query<'a>(self, client: &'a PrismaClient) -> CreateQuery<'a> {
		client.album().create(self.id, self.pub_id, self._params)
	}
	pub fn to_params(mut self) -> Vec<SetParam> {
		self._params
			.extend([id::set(self.id), pub_id::set(self.pub_id)]);
		self._params
	}
}
pub fn create(id: Int, pub_id: Bytes, _params: Vec<SetParam>) -> Create {
	Create {
		id,
		pub_id,
		_params,
...
impl CreateUnchecked {
	pub fn to_query<'a>(self, client: &'a PrismaClient) -> CreateUncheckedQuery<'a> {
		client
			.album()
			.create_unchecked(self.id, self.pub_id, self._params)
	}
...
::prisma_client_rust::macros::partial_unchecked_factory!(
	_partial_unchecked_album,
	prisma::album,
	struct Data {
		#[serde(rename = "id")]
		pub id: prisma::album::id::Type,
		#[serde(rename = "pub_id")]
		pub pub_id: prisma::album::pub_id::Type,
		#[serde(rename = "name")]
		#[serde(default, with = "::prisma_client_rust::serde::double_option")]
		pub name: prisma::album::name::Type,
		#[serde(rename = "is_hidden")]
		#[serde(default, with = "::prisma_client_rust::serde::double_option")]
		pub is_hidden: prisma::album::is_hidden::Type,
		#[serde(rename = "date_created")]
		#[serde(default, with = "::prisma_client_rust::serde::double_option")]
		pub date_created: prisma::album::date_created::Type,
		#[serde(rename = "date_modified")]
		#[serde(default, with = "::prisma_client_rust::serde::double_option")]
		pub date_modified: prisma::album::date_modified::Type,
	}
);
...
impl<'a> Actions<'a> {
	...
	pub fn create(self, id: Int, pub_id: Bytes, mut _params: Vec<SetParam>) -> CreateQuery<'a> {
		_params.extend([id::set(id), pub_id::set(pub_id)]);
