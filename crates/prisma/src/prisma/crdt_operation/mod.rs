...
::prisma_client_rust::macros::select_factory!(
	_select_crdt_operation,
	select,
	prisma::crdt_operation,
	struct Data {
		#[serde(rename = "id")]
		id: id::Type,
...
impl CreateUnchecked {
	pub fn to_query<'a>(self, client: &'a PrismaClient) -> CreateUncheckedQuery<'a> {
		client.crdt_operation().create_unchecked(
			self.timestamp,
			self.model,
			self.record_id,
			self.kind,
...
# [specta (rename = "CrdtOperation" , crate = prisma_client_rust :: specta)]
pub struct Data {
	#[serde(rename = "id")]
	pub id: id::Type,
	#[serde(rename = "timestamp")]
...
::prisma_client_rust::macros::partial_unchecked_factory!(
	_partial_unchecked_crdt_operation,
	prisma::crdt_operation,
	struct Data {
		#[serde(rename = "id")]
		pub id: prisma::crdt_operation::id::Type,
		#[serde(rename = "timestamp")]
		pub timestamp: prisma::crdt_operation::timestamp::Type,
		#[serde(rename = "model")]
		pub model: prisma::crdt_operation::model::Type,
		#[serde(rename = "record_id")]
		pub record_id: prisma::crdt_operation::record_id::Type,
		#[serde(rename = "kind")]
		pub kind: prisma::crdt_operation::kind::Type,
		#[serde(rename = "data")]
		pub data: prisma::crdt_operation::data::Type,
		#[serde(rename = "instance_id")]
		pub instance_id: prisma::crdt_operation::instance_id::Type,
	}
);
::prisma_client_rust::macros::filter_factory!(
	_crdt_operation_filter,
	prisma::crdt_operation,
	[
		(id, Scalar),
		(timestamp, Scalar),
