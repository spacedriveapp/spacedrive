...
impl From<Equals> for WhereParam {
	fn from(Equals(v): Equals) -> Self {
		WhereParam::Track(_prisma::read_filters::StringNullableFilter::Equals(v))
	}
}
...
impl From<Set> for SetParam {
	fn from(Set(v): Set) -> Self {
		Self::Track(_prisma::write_params::StringNullableParam::Set(v))
	}
}
