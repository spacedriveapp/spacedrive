...
impl From<Equals> for WhereParam {
	fn from(Equals(v): Equals) -> Self {
		WhereParam::Disc(_prisma::read_filters::StringNullableFilter::Equals(v))
	}
}
::prisma_client_rust::scalar_where_param_fns!(_prisma::read_filters::StringNullableFilter, Disc, {
...
impl From<Set> for SetParam {
	fn from(Set(v): Set) -> Self {
		Self::Disc(_prisma::write_params::StringNullableParam::Set(v))
	}
}
