...
impl From<Equals> for UniqueWhereParam {
	fn from(Equals(v): Equals) -> Self {
		UniqueWhereParam::ObjectIdEquals(v)
	}
}
impl From<Equals> for WhereParam {
	fn from(Equals(v): Equals) -> Self {
		WhereParam::ObjectId(_prisma::read_filters::IntFilter::Equals(v))
	}
}
::prisma_client_rust::scalar_where_param_fns!(_prisma::read_filters::IntFilter, ObjectId, {
