...
pub const NAME: &str = "time_base_den";
pub type Type = Int;
...
impl From<Equals> for WhereParam {
	fn from(Equals(v): Equals) -> Self {
		WhereParam::TimeBaseDen(_prisma::read_filters::IntFilter::Equals(v))
	}
}
::prisma_client_rust::scalar_where_param_fns!(_prisma::read_filters::IntFilter, TimeBaseDen, {
...
impl From<Set> for SetParam {
	fn from(Set(v): Set) -> Self {
		Self::TimeBaseDen(_prisma::write_params::IntParam::Set(v))
	}
}
...
impl Into<super::SelectParam> for Select {
	fn into(self) -> super::SelectParam {
		super::SelectParam::TimeBaseDen(self)
	}
}
...
impl Into<super::IncludeParam> for Include {
	fn into(self) -> super::IncludeParam {
		super::IncludeParam::TimeBaseDen(self)
	}
}
