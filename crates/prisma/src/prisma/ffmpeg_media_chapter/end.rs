...
impl From<Equals> for WhereParam {
	fn from(Equals(v): Equals) -> Self {
		WhereParam::End(_prisma::read_filters::BytesFilter::Equals(v))
	}
}
::prisma_client_rust::scalar_where_param_fns!(_prisma::read_filters::BytesFilter, End, {
...
impl From<Set> for SetParam {
	fn from(Set(v): Set) -> Self {
		Self::End(_prisma::write_params::BytesParam::Set(v))
	}
}
