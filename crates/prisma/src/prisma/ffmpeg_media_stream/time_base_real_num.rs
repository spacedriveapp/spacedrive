...
pub const NAME: &str = "time_base_real_num";
pub type Type = Int;
...
impl From<Equals> for WhereParam {
	fn from(Equals(v): Equals) -> Self {
		WhereParam::TimeBaseRealNum(_prisma::read_filters::IntFilter::Equals(v))
	}
}
::prisma_client_rust::scalar_where_param_fns!(_prisma::read_filters::IntFilter, TimeBaseRealNum, {
...
impl From<Order> for super::OrderByWithRelationParam {
	fn from(Order(v): Order) -> Self {
		Self::TimeBaseRealNum(v)
	}
}
pub struct Set(pub Int);
impl From<Set> for SetParam {
	fn from(Set(v): Set) -> Self {
		Self::TimeBaseRealNum(_prisma::write_params::IntParam::Set(v))
	}
}
...
impl Into<super::SelectParam> for Select {
	fn into(self) -> super::SelectParam {
		super::SelectParam::TimeBaseRealNum(self)
	}
}
...
impl Into<super::IncludeParam> for Include {
	fn into(self) -> super::IncludeParam {
		super::IncludeParam::TimeBaseRealNum(self)
	}
}
