...
pub const NAME: &str = "aspect_ratio_num";
pub type Type = Int;
...
impl From<Equals> for WhereParam {
	fn from(Equals(v): Equals) -> Self {
		WhereParam::AspectRatioNum(_prisma::read_filters::IntFilter::Equals(v))
	}
}
::prisma_client_rust::scalar_where_param_fns!(_prisma::read_filters::IntFilter, AspectRatioNum, {
...
impl From<Order> for super::OrderByWithRelationParam {
	fn from(Order(v): Order) -> Self {
		Self::AspectRatioNum(v)
	}
}
pub struct Set(pub Int);
impl From<Set> for SetParam {
	fn from(Set(v): Set) -> Self {
		Self::AspectRatioNum(_prisma::write_params::IntParam::Set(v))
	}
}
...
impl Into<super::SelectParam> for Select {
	fn into(self) -> super::SelectParam {
		super::SelectParam::AspectRatioNum(self)
	}
}
...
impl Into<super::IncludeParam> for Include {
	fn into(self) -> super::IncludeParam {
		super::IncludeParam::AspectRatioNum(self)
	}
}
