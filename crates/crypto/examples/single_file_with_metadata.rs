...
use sd_crypto::{Protected, primitives::{generate_master_key, generate_salt}, keys::hashing::{HashingAlgorithm, Params}, crypto::stream::{Algorithm, StreamEncryption}, header::{keyslot::{Keyslot, KeyslotVersion}, file::{FileHeader, FileHeaderVersion}, metadata::{Metadata, MetadataVersion}}};
...
pub fn decrypt_metadata() {
    ...
    let hashed_key = metadata.hashing_algorithm.hash(password, metadata.salt).unwrap();
