...
///< the section may contain a variable number of fields with variable keys. For
///< these sections the element_name field is mandatory.
...
#define SECTION_FLAG_HAS_TYPE 8
  ...
  ///< function returning a type if defined, must be defined when
  ///< SECTION_FLAG_HAS_TYPE is defined
