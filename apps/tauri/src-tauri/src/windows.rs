    ...
    async fn create(&self, app: &AppHandle) -> Result<WebviewWindow, String> {
        ...
        match self {
            ...
            Self::FloatingControls => {
                ...
                let window = WebviewWindowBuilder::new(app, label, WebviewUrl::App("/floating-controls".into()))
                    .title("Controls")
