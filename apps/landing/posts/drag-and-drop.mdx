---
author: Jamie Pine
title: Introducing Spacedrive Alpha v0.2 - Drag & drop, AI Labels, Advanced Search, 12 Languages, Tabs,  and Spacedrop!
...
It's been an exciting couple of months since we launched Spacedrive. We're thrilled to share that we've hit **139,000** unique installations, with an average runtime of **50 minutes**. The enthusiasm and feedback from our community have been incredible, and your requests for new features have not gone unnoticed.
...
We've expanded our language options to include English, Japanese, Chinese (Simplified and Traditional), German, French, Hindi, Portuguese, Dutch, Italian, Russian, Korean, Spanish, Turkish, and Arabic. Some translations were created with AI assistance, so feel free to submit corrections on [GitHub](https://github.com/spacedriveapp/spacedrive).
