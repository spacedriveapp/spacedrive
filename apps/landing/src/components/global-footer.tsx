...
export function GlobalFooter() {
	...
	return (
		<div className="relative">
			...
			<div className="absolute inset-x-0 top-[-50px] mx-auto size-[200px] md:top-[-100px] md:size-[500px]">
				<Particles
					quantity={50}
					ease={80}
					staticity={100}
			...
			<footer
				className="relative z-10 pt-12 overflow-hidden text-gray-200"
				style={{
			...
			>
				<div className="container mx-auto grid h-fit w-full flex-shrink-0 grid-cols-1 grid-rows-3 gap-x-8 gap-y-16 fill-[#141419] px-8 pb-20 pt-20 lg:grid-cols-6 lg:grid-rows-1 lg:gap-y-8">
