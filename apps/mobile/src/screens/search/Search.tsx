			...
			<View style={tw`relative z-20 border-b border-app-cardborder bg-app-header`}>
				...
				<View style={tw`flex-row items-center justify-between gap-4 px-5 pb-3`}>
					...
					<View style={tw`flex-row items-center flex-1 gap-2`}>
						<View
							style={tw`flex-wrap w-4/5 h-10 border rounded-md border-app-inputborder bg-app-input`}
						>
						...
						<Pressable onPress={() => navigation.navigate('Filters')}>
							<View
								style={tw`items-center justify-center w-10 h-10 border rounded-md border-app-inputborder bg-app-input`}
							>
