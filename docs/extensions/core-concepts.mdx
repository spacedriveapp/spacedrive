...
Spacedrive extensions are built using a declarative, attribute-based approach in Rust. These attributes allow you to define the structure and behavior of your extension in a clear and concise way. This document covers the primary concepts you'll use to build your own extensions.
