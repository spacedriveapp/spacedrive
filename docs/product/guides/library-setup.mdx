...
It is possible to create multiple libraries. If you do so, they will exist completely separate of eachother and will not share any data. You can choose to create a new library through the Library switcher dropdown in the top left corner of the app.
