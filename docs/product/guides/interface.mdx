...
The network tab shows you all the devices connected to your library, you can see their status, and even browse their filesystems. This is where you can view and manage [Nodes](/docs/product/guides/network#Nodes) and [Shares](/docs/product/guides/network#Shares) across your networks.
