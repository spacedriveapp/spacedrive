...
The network tab shows you all the devices connected to your library, you can see their status, and even browse their filesystems. This is where you can manage your [Nodes](/docs/product/guides/nodes) and [Shares](/docs/product/guides/shares).
