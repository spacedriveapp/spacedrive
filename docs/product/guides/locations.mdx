...
<Notice
	...
	text="This feature is not available yet, please check our [roadmap](/roadmap)."
/>
A Location can be set to have a size limit, this will prevent the Location from growing beyond the set
limit. Files will be removed from the Location based on the last accessed time, oldest files will be
removed first.
