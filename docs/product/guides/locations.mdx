...
Spacedrive allows you to browse your local system before creating a Location, but it may take longer to load explorer data without the indexing process of Locations.

You can convert any local path to a Location when browsing your local filesystem.

## Scanning

When a Location is added it is immediately scanned. The scan happens via several phases as [Jobs](/docs/product/guides/jobs).
