...
We are working on a "tag assign mode" which will show relevant tags on a hotbar at the bottom of the Explorer. Each tag will be assigned a number, selecting files and pressing the number will assign the given tag to all selected files.
