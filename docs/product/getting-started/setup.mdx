...
We're still in alpha, so there are a few known issues. If you're having trouble, please check the following. You can join our [Discord](https://discord.gg/gTaF2Z44f5) server to ask for help or report a bug.
