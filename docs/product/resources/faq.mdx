...
Spacedrive is a free, open source application that consolidates all your files from different storage locations into a single place. It is a file explorer that is powered by a database, allowing you to organize and search your files in ways that are not possible with traditional file explorers or cloud services.
