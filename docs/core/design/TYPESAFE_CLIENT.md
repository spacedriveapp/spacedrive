...
fn generate_client_schemas() -> Result<(), Box<dyn std::error::Error>> {
    ...
    // Step 3: NEW - Auto-generate the Rust FFI bridge source code
...
echo "️Generating Spacedrive Swift Client"
echo "=========================================="
...
echo -e "${GREEN}Generated types.swift (App Layer)${NC}"
...
echo -e "${GREEN}Generated SpacedriveBridge.swift (FFI Layer)${NC}"
...
echo "️Generating Spacedrive TypeScript Client"
echo "============================================="
