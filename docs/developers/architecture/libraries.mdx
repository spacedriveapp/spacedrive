...
You must create a library to use Spacedrive, you can create more libraries, such as one specifically for work and Spacedrive will run them both in unison.
