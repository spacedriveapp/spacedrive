...
function ShellLayoutContent() {
  ...
  return (
    <div className="frame relative flex h-screen select-none flex-col overflow-hidden rounded-[10px] border border-transparent bg-app text-sidebar-ink">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <div className="relative z-30 flex flex-1 flex-col overflow-hidden pt-12">
