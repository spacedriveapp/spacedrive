...
export function MediaView() {
  ...
  const dateRange = useMemo(() => {
    ...
    const firstItemIndex = firstRowIndex * columns;
  ...
  if (!currentPath) {
    return (
      <div className="flex h-full flex-col items-center justify-center gap-2 text-ink-dull">
  ...
  if (files.length === 0) {
    return (
      <div className="flex h-full flex-col items-center justify-center gap-2 text-ink-dull">
        ...
        <div className="text-sm">No images or videos in this location</div>
      </div>
    );
  }
  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none sticky top-3 left-3 z-20">
      ...
      >
        {virtualRows.map((virtualRow) => {
          ...
          return Array.from({ length: endIndex - startIndex }, (_, idx) => {
