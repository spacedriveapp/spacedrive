...
export const ThumbstripScrubber = memo(function ThumbstripScrubber({
  ...
  return (
    ...
    >
      ...
      {isHovering && (
        <div
          className="relative overflow-hidden rounded-lg bg-app-darkBox/95 shadow-lg backdrop-blur-sm"
          style={{
            width: scrubberWidth,
        ...
        >
          {/* Progress indicator */}
          <div className="absolute right-1 bottom-1 left-1 h-0.5 overflow-hidden rounded-full bg-black/50">
            <div
