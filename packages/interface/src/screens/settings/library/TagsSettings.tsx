...
import { Button, Card, Dialog, NewDialogProps, Switch, dialogManager, useDialog } from '@sd/ui';
...
function CreateTagDialog(props: NewDialogProps) {
...
interface DeleteTagDialogProps extends NewDialogProps {
	tagId: number;
	onSuccess: () => void;
}
