...
export function JobProgressBar({ progress, status }: JobProgressBarProps) {
  ...
  return (
    <div
      className="mt-1.5 w-full overflow-hidden rounded-full bg-app-line/30"
    ...
    >
      {isPending ? (
        <div
          ...
          style={{
            backgroundImage:
              "repeating-linear-gradient(45deg, rgb(0, 122, 255), rgb(0, 122, 255) 10px, rgb(80, 170, 255) 10px, rgb(80, 170, 255) 20px)",
