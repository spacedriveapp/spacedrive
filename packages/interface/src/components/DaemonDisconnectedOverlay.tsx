            ...
            <div className="flex flex-1 flex-col items-center justify-center gap-6 px-12">
              ...
              <div className="flex flex-col items-center gap-2 text-center">
                ...
                <p className="max-w-xs text-sm leading-relaxed text-ink-dull">
                  The Spacedrive daemon is required for the app to function. It runs in the background,
                  managing your libraries, indexing files, and syncing data across devices.
                </p>
              </div>
