...
import { type SubtitleSettings, Subtitles } from "./Subtitles";
...
export function VideoPlayer({
  ...
  return (
    ...
    >
      ...
      {zoom > 1 && (
        <div className="absolute top-4 left-4 z-20 rounded-lg bg-black/80 px-3 py-1.5 font-medium text-sm text-white backdrop-blur-xl">
          {Math.round(zoom * 100)}%
        </div>
      )}
      ...
      >
        <div className="flex items-center justify-center" style={transform}>
          <video
            autoPlay
