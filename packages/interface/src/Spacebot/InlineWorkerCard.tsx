			...
			>
				...
				<div className="min-w-0 flex-1">
					<div className="flex items-center gap-2">
						<div className="text-ink text-sm font-medium">{worker.task}</div>
						<span
							className={clsx(
					...
					>
						<div className="border-app-line/30 flex flex-col gap-2 border-t px-4 py-3">
							<div className="flex items-center justify-between">
								<div className="text-ink-faint text-[11px] uppercase tracking-[0.12em]">Actions</div>
								<TopBarButtonGroup>
									<TopBarButton
										icon={Copy}
									...
									<TopBarButton
										...
										title="Cancel worker"
										disabled={!isRunning || !worker.channel_id || cancelMutation.isPending}
									/>
								</TopBarButtonGroup>
							</div>
