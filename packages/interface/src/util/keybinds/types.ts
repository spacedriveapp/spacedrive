/**
 * Keybind System Type Definitions
 *
 * This module provides type-safe definitions for the unified keybind system.
 * All keybinds are defined once and work across both web and Tauri platforms.
 */
...
/**
 * Helper function to define keybinds with type safety.
 * This function provides autocomplete and type checking for keybind definitions.
 */
...
/**
 * Type guard to check if a combo has platform-specific overrides
 */
