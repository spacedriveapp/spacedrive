...
export interface ContextMenuItem {
	...
	keybind?: string;
	/** Type-safe keybind ID from registry - auto-resolves to platform-specific display string */
	keybindId?: KeybindId;
...
function resolveKeybindDisplay(item: ContextMenuItem): ContextMenuItem {
	// If keybindId is provided, resolve to platform-specific display string
...
export function useContextMenu(config: ContextMenuConfig): ContextMenuResult {
	...
	// Process items to resolve keybindId to display strings
