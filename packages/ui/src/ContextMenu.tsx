  ...
  ],
  {
    variants: {
      variant: {
        ...
        dull: "group-radix-highlighted:!text-menu-ink group-radix-state-open:!text-ink group-radix-highlighted:bg-app-selected/50 group-radix-state-open:bg-app-selected/50",
        danger: [
...
const CheckboxItem = ({
  ...
  return (
    <RadixCM.CheckboxItem className={contextMenuItemClassNames} {...props}>
      <ContextMenuDivItem className={className} variant={variant}>
...
const ItemInternals = ({
  ...
  return (
    <>
      ...
      {keybind && (
        <span className="font-medium text-xs group-radix-highlighted:text-white">
          {keybind}
        </span>
      )}
      {rightArrow && (
