...
export type Procedures = {
    ...
    mutations: 
        ...
        { key: "tags.update", input: LibraryArgs<[number, TagUpdateArgs]>, result: null },
    subscriptions: 
...
export type TagUpdateArgs = { name?: string | null; color?: string | null }
...
export type ObjectWithFilePaths = { id: number; pub_id: number[]; kind: number; key_id: number | null; hidden: boolean; important: boolean; has_thumbnail: boolean; has_thumbstrip: boolean; has_video_preview: boolean; ipfs_id: string | null; note: string | null; date_created: string; date_accessed: string | null; file_paths: FilePath[] }
