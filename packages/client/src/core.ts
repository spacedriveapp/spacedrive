...
export type Procedures = {
    queries:
        ...
        { key: "search.paths", input: LibraryArgs<{ locationId?: number | null; afterFileId?: string | null; take?: number | null; order?: Ordering | null; search?: string; extension?: string | null; kind?: number[]; tags?: number[]; createdAt?: OptionalRange<string>; path?: string | null; cursor?: number[] | null; favorite?: boolean | null; hidden?: boolean | null }>, result: SearchData<ExplorerItem> } |
...
export type ObjectWithFilePaths = { id: number; pub_id: number[]; location_id: number; kind: number; key_id: number | null; hidden: boolean; favorite: boolean; important: boolean; has_thumbnail: boolean; has_thumbstrip: boolean; has_video_preview: boolean; ipfs_id: string | null; note: string | null; date_created: string; date_accessed: string | null; file_paths: FilePath[] }
...
export type FilePathWithObject = { id: number; pub_id: number[]; location_id: number;  is_dir: boolean; cas_id: string | null; integrity_checksum: string | null; materialized_path: string; name: string; extension: string; size_in_bytes: string; inode: number[]; device: number[]; object_id: number | null; key_id: number | null; date_created: string; date_modified: string; date_indexed: string; object: Object | null }
