...
export type Procedures = { queries: { key: "auth.me"; input: never; result: null; error: SdError } | { key: "backups.getAll"; input: never; result: GetAll; error: SdError } | { key: "buildInfo"; input: never; result: BuildInfo; error: SdError } | { key: "categories.list"; input: never; result: { [key in Category]: number }; error: SdError } | { key: "files.get"; input: GetArgs; result: { id: number; pub_id: number[]; kind: number | null; key_id: number | null; hidden: boolean | null; favorite: boolean | null; important: boolean | null; note: string | null; date_created: string | null; date_accessed: string | null; file_paths: FilePath[] } | null; error: SdError } | { key: "files.getConvertableImageExtensions"; input: never; result: string[]; error: SdError } | { key: "files.getEphemeralMediaData"; input: string; result: ({ type: "Image" } & ImageMetadata) | ({ type: "Video" } & VideoMetadata) | ({ type: "Audio" } & AudioMetadata) | null; error: SdError } | { key: "files.getMediaData"; input: number; result: MediaMetadata; error: SdError } | { key: "files.getPath"; input: number; result: string | null; error: SdError } | { key: "invalidation.test-invalidate"; input: never; result: number; error: SdError } | { key: "jobs.isActive"; input: never; result: boolean; error: SdError } | { key: "jobs.reports"; input: never; result: JobGroup[]; error: SdError } | { key: "library.list"; input: never; result: LibraryConfigWrapped[]; error: SdError } | { key: "library.statistics"; input: never; result: Statistics; error: SdError } | { key: "locations.get"; input: number; result: { id: number; pub_id: number[]; name: string | null; path: string | null; total_capacity: number | null; available_capacity: number | null; size_in_bytes: number[] | null; is_archived: boolean | null; generate_preview_media: boolean | null; sync_preview_media: boolean | null; hidden: boolean | null; date_created: string | null; instance_id: number | null } | null; error: SdError } | { key: "locations.getWithRules"; input: number; result: { id: number; pub_id: number[]; name: string | null; path: string | null; total_capacity: number | null; available_capacity: number | null; size_in_bytes: number[] | null; is_archived: boolean | null; generate_preview_media: boolean | null; sync_preview_media: boolean | null; hidden: boolean | null; date_created: string | null; instance_id: number | null; indexer_rules: { indexer_rule: IndexerRule }[] } | null; error: SdError } | { key: "locations.indexer_rules.get"; input: number; result: IndexerRule; error: SdError } | { key: "locations.indexer_rules.list"; input: never; result: IndexerRule[]; error: SdError } | { key: "locations.indexer_rules.listForLocation"; input: number; result: IndexerRule[]; error: SdError } | { key: "locations.list"; input: never; result: Location[]; error: SdError } | { key: "locations.systemLocations"; input: never; result: SystemLocations; error: SdError } | { key: "nodeState"; input: never; result: NodeState; error: SdError } | { key: "nodes.listLocations"; input: string | null; result: ExplorerItem[]; error: SdError } | { key: "notifications.dismiss"; input: NotificationId; result: null; error: SdError } | { key: "notifications.dismissAll"; input: never; result: null; error: SdError } | { key: "notifications.get"; input: never; result: Notification[]; error: SdError } | { key: "preferences.get"; input: never; result: LibraryPreferences; error: SdError } | { key: "search.ephemeralPaths"; input: EphemeralPathSearchArgs; result: NonIndexedFileSystemEntries; error: SdError } | { key: "search.objects"; input: ObjectSearchArgs; result: SearchData<ExplorerItem>; error: SdError } | { key: "search.objectsCount"; input: { filter?: ObjectFilterArgs }; result: number; error: SdError } | { key: "search.paths"; input: FilePathSearchArgs; result: SearchData<ExplorerItem>; error: SdError } | { key: "search.pathsCount"; input: { filter?: FilePathFilterArgs }; result: number; error: SdError } | { key: "sync.messages"; input: never; result: CRDTOperation[]; error: SdError } | { key: "tags.get"; input: number; result: { id: number; pub_id: number[]; name: string | null; color: string | null; redundancy_goal: number | null; date_created: string | null; date_modified: string | null } | null; error: SdError } | { key: "tags.getForObject"; input: number; result: Tag[]; error: SdError } | { key: "tags.getWithObjects"; input: number[]; result: { [key in number]: number[] }; error: SdError } | { key: "tags.list"; input: never; result: Tag[]; error: SdError } | { key: "volumes.list"; input: never; result: Volume[]; error: SdError }; mutations: { key: "api.sendFeedback"; input: Feedback; result: null; error: SdError } | { key: "auth.logout"; input: never; result: null | { code: ErrorCode; message: string }; error: SdError } | { key: "backups.backup"; input: never; result: string; error: SdError } | { key: "backups.delete"; input: string; result: null; error: SdError } | { key: "backups.restore"; input: string; result: null; error: SdError } | { key: "files.convertImage"; input: ConvertImageArgs; result: null; error: SdError } | { key: "files.copyFiles"; input: FileCopierJobInit; result: null; error: SdError } | { key: "files.createEphemeralFolder"; input: CreateEphemeralFolderArgs; result: string; error: SdError } | { key: "files.createFolder"; input: CreateFolderArgs; result: string; error: SdError } | { key: "files.cutFiles"; input: FileCutterJobInit; result: null; error: SdError } | { key: "files.deleteFiles"; input: FileDeleterJobInit; result: null; error: SdError } | { key: "files.duplicateFiles"; input: FileCopierJobInit; result: null; error: SdError } | { key: "files.eraseFiles"; input: FileEraserJobInit; result: null; error: SdError } | { key: "files.removeAccessTime"; input: number[]; result: null; error: SdError } | { key: "files.renameFile"; input: RenameFileArgs; result: null; error: SdError } | { key: "files.setFavorite"; input: SetFavoriteArgs; result: null; error: SdError } | { key: "files.setNote"; input: SetNoteArgs; result: null; error: SdError } | { key: "files.updateAccessTime"; input: number[]; result: null; error: SdError } | { key: "invalidation.test-invalidate-mutation"; input: never; result: null; error: SdError } | { key: "jobs.cancel"; input: string; result: null; error: SdError } | { key: "jobs.clear"; input: string; result: null; error: SdError } | { key: "jobs.clearAll"; input: never; result: null; error: SdError } | { key: "jobs.generateThumbsForLocation"; input: GenerateThumbsForLocationArgs; result: null; error: SdError } | { key: "jobs.identifyUniqueFiles"; input: IdentifyUniqueFilesArgs; result: null; error: SdError } | { key: "jobs.objectValidator"; input: ObjectValidatorArgs; result: null; error: SdError } | { key: "jobs.pause"; input: string; result: null; error: SdError } | { key: "jobs.resume"; input: string; result: null; error: SdError } | { key: "library.create"; input: CreateLibraryArgs; result: LibraryConfigWrapped; error: SdError } | { key: "library.delete"; input: string; result: null; error: SdError } | { key: "library.edit"; input: EditLibraryArgs; result: null; error: SdError } | { key: "locations.addLibrary"; input: LocationCreateArgs; result: number | null; error: SdError } | { key: "locations.create"; input: LocationCreateArgs; result: number | null; error: SdError } | { key: "locations.delete"; input: number; result: null; error: SdError } | { key: "locations.fullRescan"; input: FullRescanArgs; result: null; error: SdError } | { key: "locations.indexer_rules.create"; input: IndexerRuleCreateArgs; result: null; error: SdError } | { key: "locations.indexer_rules.delete"; input: number; result: null; error: SdError } | { key: "locations.relink"; input: string; result: number; error: SdError } | { key: "locations.subPathRescan"; input: RescanArgs; result: null; error: SdError } | { key: "locations.update"; input: LocationUpdateArgs; result: null; error: SdError } | { key: "nodes.edit"; input: ChangeNodeNameArgs; result: null; error: SdError } | { key: "notifications.test"; input: never; result: null; error: SdError } | { key: "notifications.testLibrary"; input: never; result: null; error: SdError } | { key: "p2p.acceptSpacedrop"; input: [string, string | null]; result: null; error: SdError } | { key: "p2p.cancelSpacedrop"; input: string; result: null; error: SdError } | { key: "p2p.pair"; input: RemoteIdentity; result: number; error: SdError } | { key: "p2p.pairingResponse"; input: [number, PairingDecision]; result: null; error: SdError } | { key: "p2p.spacedrop"; input: SpacedropArgs; result: string; error: SdError } | { key: "preferences.update"; input: LibraryPreferences; result: null; error: SdError } | { key: "tags.assign"; input: { targets: Target[]; tag_id: number; unassign: boolean }; result: null; error: SdError } | { key: "tags.create"; input: TagCreateArgs; result: Tag; error: SdError } | { key: "tags.delete"; input: number; result: null; error: SdError } | { key: "tags.update"; input: TagUpdateArgs; result: null; error: SdError } | { key: "toggleFeatureFlag"; input: BackendFeature; result: null; error: SdError }; subscriptions: { key: "auth.loginSession"; input: never; result: Response; error: SdError } | { key: "invalidation.listen"; input: never; result: InvalidateOperationEvent[]; error: SdError } | { key: "jobs.newThumbnail"; input: never; result: string[]; error: SdError } | { key: "jobs.progress"; input: never; result: JobProgressEvent; error: SdError } | { key: "locations.online"; input: never; result: number[][]; error: SdError } | { key: "notifications.listen"; input: never; result: Notification; error: SdError } | { key: "p2p.events"; input: never; result: P2PEvent; error: SdError } | { key: "sync.newMessage"; input: never; result: null; error: SdError } }
