...
export type Volume = { name: string; mount_point: string[]; total_capacity: string; available_capacity: string; is_removable: boolean; disk_type: DiskType; file_system: string | null; is_root_filesystem: boolean }
